...
interface AntiquedaHeroProps {
  config: any;
  formatTime: (seconds: number) => string;
  timeLeft: number;
}

export const AntiquedaHero = ({ config, formatTime, timeLeft }: AntiquedaHeroProps) => {
            ...
            <div className="lg:col-span-6 space-y-6">
                ...
                <div className="space-y-4 pt-4">
                    <Link href={config.checkoutUrl} target="_blank">
                        <Button className="w-full h-20 text-white rounded-full font-black text-2xl uppercase tracking-widest shadow-2xl transition-all hover:scale-[1.01] flex items-center justify-center gap-4 group" style={{ backgroundColor: '#35c867' }}>
