...
export const ArticleContent = () => {
  return (
    <div className="max-w-none space-y-8 text-xl leading-relaxed text-slate-700">
      ...
      <p>Teve um domingo que eu não fui ao churrasco da família. Inventei uma dor de cabeça porque eu não conseguia arranjar um penteado que me fizesse sentir presentável. Aquele domingo foi o fundo do poço pra mim.</p>
