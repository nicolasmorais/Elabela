                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-12">
                            ...
                            <div className="space-y-10 relative">
                                ...
                                {[
                                    { icon: Anchor, t: "BIOTINA (Vitamina H)", bullets: ["Ancora o fio na raiz", "Reduz queda por enfraquecimento"], feel: "Menos fios no ralo em 3 dias" },
                                    { icon: Dumbbell, t: "PROTEÍNA DE TRIGO HIDROLISADA", bullets: ["Reconstrói fibra capilar", "Preenche \"buracos\" do fio"], feel: "Fio 3x mais forte em 1 semana" },
                                    { icon: Droplets, t: "PANTENOL (Pró-Vitamina B5)", bullets: ["Sela cutículas e protege", "Forma filme protetor"], feel: "Escova sem quebra imediata" }
                                ].map((item, i) => (
                        ...
                        <div className="bg-slate-950 rounded-[4rem] p-10 md:p-16 text-white space-y-12 relative overflow-hidden shadow-2xl">
                            ...
                            <div className="space-y-8 relative z-10">
                                ...
                                <div className="space-y-6">
                                    {["pH Balanceado (não agride raiz)", "Concentração Profissional", "Sistema 4 Passos (sinergia completa)"].map((diff, i) => (
                ...
                <div className="max-w-6xl mx-auto space-y-20">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        <div className="bg-white rounded-[3.5rem] p-8 md:p-12 shadow-xl border border-orange-50 space-y-10 h-full">
                            ...
                            <div className="space-y-8">
                                {[
                                    { n: "1", t: "SHAMPOO RECONSTRUTOR", d: "Aplique no cabelo molhado, massageie até espumar. Enxágue e REPITA.", time: "3 minutos" },
                                    { n: "2", t: "CONDICIONADOR FORTIFICANTE", d: "Aplique do meio às pontas. Deixe agir por 2 minutos e enxágue.", time: "2 minutos" },
                                    { n: "3", t: "LEAVE-IN PROTETOR", d: "Com o cabelo úmido, espalhe nas mãos e aplique. NÃO enxágue.", time: "1 minuto" }
                                ].map((step, i) => (
                                    <div key={i} className="flex gap-6 group">
                                        <div className="h-10 w-10 shrink-0 bg-[#FDF8F3] rounded-xl flex items-center justify-center font-black text-orange-800 text-lg border border-orange-100">{step.n}</div>
                                        <div className="space-y-2">
                                ...
                                <div className="flex gap-6 group">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="flex items-center gap-1.5 text-[10px] font-black text-orange-600 uppercase tracking-widest bg-orange-50 px-2.5 py-1 rounded-full"><Clock size={12} /> 15 min</span>
                                        </div>
                                        <ul className="space-y-3">
                                            {["Após o shampoo, retire o excesso de água", "Aplique do comprimento às pontas mecha a mecha", "Deixe agir de 10 a 15 minutos e enxágue"].map((li, i) => (
                ...
                <div className="max-w-6xl mx-auto space-y-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {DELIVERY_TESTIMONIALS.map((test, i) => (
                            <div key={i} className="group bg-white rounded-[3rem] overflow-hidden shadow-2xl border border-orange-50 transition-all hover:scale-[1.02] flex flex-col">
                ...
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <Accordion type="single" collapsible className="w-full space-y-3">
                        {[
                            ...
                            { q: "❓ Tenho química, posso usar?", a: "PODE. E deve. Química enfraquece, este kit reconstrói." },
              ...
              <div className="max-w-6xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16 pb-16 border-b border-orange-100">
                    <div className="space-y-4">
                        ...
                        <p className="text-xs text-slate-500">Este conteúdo tem caráter informativo e educacional. Não oferece diagnóstico ou cura.</p>
                    </div>
                    <div className="space-y-6 text-center md:text-left">
                        ...
                        <p className="text-xs text-slate-500">OneBase | Soluções Digitais<br />CNPJ: 60.357.932/0001-18</p>
                    </div>
                </div>
                <div className="text-center opacity-50 flex justify-center gap-6"><ShieldCheck size={40} /><Lock size={40} /><CreditCard size={40} /></div>
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em] text-center mt-8">© 2024 Cavalo de Raça - Original Bio Instinto</p>
              </div>
            </footer>
        </div>
