            ...
            <footer className="py-20 bg-[#FDF8F3] text-slate-900 border-t border-slate-200">
              <div className="max-w-6xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16 pb-16 border-b border-orange-100">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-4 text-xs text-slate-500 leading-relaxed text-justify">
                            <p>Este conteúdo tem caráter informativo. Os produtos não substituem recomendações médicas. Resultados variam de pessoa para pessoa.</p>
                        </div>
                    </div>
                ...
                <nav className="flex flex-col md:flex-row gap-8 justify-center mb-12 text-xs font-bold uppercase tracking-widest text-slate-500">
                    <Dialog><DialogTrigger className="hover:text-orange-600">Termos e Condições</DialogTrigger><DialogContent className="max-w-2xl"><DialogHeader><DialogTitle>Termos</DialogTitle></DialogHeader><ScrollArea className="h-96 pr-4 text-sm leading-relaxed"><p>Ao acessar este site, o usuário concorda com os termos informativos...</p></ScrollArea></DialogContent></Dialog>
                    <Dialog><DialogTrigger className="hover:text-orange-600">Privacidade</DialogTrigger><DialogContent className="max-w-2xl"><DialogHeader><DialogTitle>Privacidade</DialogTitle></DialogHeader><ScrollArea className="h-96 pr-4 text-sm leading-relaxed"><p>Valorizamos sua privacidade...</p></ScrollArea></DialogContent></Dialog>
                </nav>
