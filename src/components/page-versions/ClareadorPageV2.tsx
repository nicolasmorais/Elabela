...
// IMAGENS EXCLUSIVAS DA GALERIA DE PRODUTO
...
// DEFINIÇÃO DOS KITS CONFORME IMAGEM
const CLAREADOR_KITS: KitOption[] = [
  {
    id: '1-un',
    units: 1,
    discount: '21% OFF',
...
const DELIVERY_TESTIMONIALS = [
  ...
  },
  {
    ...
    text: "Impecável a entrega! O cheiro o resultado no primeiro dia me surpreendeu. O cabelo ficou soltinho e senti que parou de quebrar tanto.",
...
export function ClareadorPageV2() {
  ...
  const [selectedKit, setSelectedKit] = useState<KitOption>(CLAREADOR_KITS[1]); // Padrão: 3 unidades
  ...
  return (
    <>
      ...
      <div className="bg-white text-slate-900 font-sans selection:bg-orange-100 antialiased min-h-screen">
        ...
        <main className="max-w-7xl mx-auto px-6 py-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="lg:col-span-6 space-y-8">
                    ...
                    {/* SELETOR DE KITS (POSIÇÃO 178:8) */}
                    <div className="pt-2">
                      <KitSelector 
                        options={CLAREADOR_KITS} 
                    ...
                    <div className="flex flex-col lg:flex-row items-start gap-16">
                        <div className="flex-1 space-y-8">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black text-slate-950 tracking-tighter leading-tight">
                                O Mesmo Tratamento Profissional Que Clínicas Cobram R$ 800. <span className="text-orange-700">Agora no Conforto da Sua Casa Por R$ 117,70.</span>
                            </h2>
        ...
        <MobileStickyBar 
          installmentText={selectedKit.units > 1 ? `12x de ${(parseFloat(selectedKit.price.replace(',', '.')) / 12).toFixed(2).replace('.', ',')}` : "12x de 14,96"} 
