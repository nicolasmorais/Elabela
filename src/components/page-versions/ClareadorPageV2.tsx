    ...
    <>
      ...
      <div className="bg-white text-slate-900 font-sans selection:bg-orange-100 antialiased min-h-screen">
        ...
        <div className="border-t border-slate-100 bg-white">
                        ...
                        <div className="flex-1 space-y-8">
                            ...
                            <div className="pt-8 space-y-6">
                                ...
                                <div className="space-y-4 text-2xl font-black text-slate-900 tracking-tight leading-tight pt-4">
                                    <p>Porque você merece acordar SEM problemas no travesseiro.</p>
                                    <p className="text-orange-800 italic underline decoration-orange-300">Sem precisar escolher entre: Ter resultado OU pagar as contas.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-6xl mx-auto space-y-24">
                    <div className="text-center space-y-6 max-w-4xl mx-auto">
                        ...
                        <h2 className="text-4xl md:text-7xl font-black tracking-tighter text-slate-950 uppercase leading-[0.9] mb-4">
                            POR QUE ESTE MÉTODO EM <span className="text-orange-600">7 DIAS?</span>
                        </h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            ...
                            <p className="text-xl text-slate-700 font-medium leading-relaxed">
                                O tratamento age em <span className="text-orange-600 font-black">3 PILARES:</span>
                            </p>
            ...
            {/* SEÇÃO: POR QUE ESCOLHER ESTE KIT? */}
            <section className="py-32 px-6 bg-white overflow-hidden border-b border-slate-100">
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-12">
                            <div className="space-y-4">
                                <span className="text-orange-600 font-black text-xs uppercase tracking-[0.4em] block">Qualidade Garantida</span>
                                <h2 className="text-4xl md:text-6xl font-black text-slate-950 tracking-tighter uppercase leading-none">
                                    POR QUE <span className="text-orange-700 italic">ESTE KIT</span> E OUTROS NÃO?
                                </h2>
                            ...
                            <div className="space-y-10 relative">
                                ...
                                {[
                                    { icon: Anchor, n: "1️⃣", t: "BIOTINA (Vitamina H)", bullets: ["Ancora o fio na raiz", "Reduz queda por enfraquecimento"], feel: "Resultados visíveis em 3 dias" },
                                    { icon: Dumbbell, n: "2️⃣", t: "PROTEÍNA DE TRIGO HIDROLISADA", bullets: ["Reconstrói fibra capilar", "Preenche \"buracos\" do fio"], feel: "Fio 3x mais forte em 1 semana" },
                                    { icon: Droplets, n: "3️⃣", t: "PANTENOL (Pró-Vitamina B5)", bullets: ["Sela cutículas e protege", "Forma filme protetor"], feel: "Escova sem quebra imediata" }
                                ].map((item, i) => (
                ...
                <div className="max-w-6xl mx-auto space-y-20">
                    <div className="text-center space-y-6 max-w-4xl mx-auto">
                        ...
                        <h2 className="text-4xl md:text-7xl font-black tracking-tighter text-slate-950 uppercase leading-[0.9]">
                            COMO USAR O <span className="text-orange-700">KIT COMPLETO</span>
                        </h2>
                        <p className="text-xl md:text-2xl font-bold text-slate-400 uppercase tracking-tight">
                            ...
                            <div className="bg-white rounded-[3.5rem] p-8 md:p-12 shadow-xl border border-orange-50 space-y-10 flex-1 relative overflow-hidden">
                                ...
                                <div className="space-y-6">
                                    <div className="flex gap-6 group">
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center justify-between">
                                                <h4 className="font-black text-slate-950 text-lg uppercase tracking-tight">MÁSCARA INTENSIVA</h4>
                    ...
                    <div className="bg-white rounded-[3.5rem] p-8 md:p-16 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] border-4 border-white relative overflow-hidden">
                        <div className="space-y-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
                                {[
                                    { t: "Shampoo Reconstrutor 300ml", d: "Ancora a raiz" },
                                    { t: "Condicionador Fortificante 300ml", d: "Sela cutícula" },
                                    { t: "Máscara Intensiva 250g", d: "Reconstrói fibra" },
                                    { t: "Leave-in Protetor 200ml", d: "Protege estrutura" }
                                ].map((item, i) => (
                    ...
                    <div className="space-y-12">
                        <div className="space-y-6">
                            ...
                            <Accordion type="single" collapsible className="w-full space-y-3">
                                {[
                                    { q: "❓ Funciona mesmo?", a: "SIM. 12.847 clientes comprovam. Garantia de 7 dias: não funcionou = dinheiro de volta." },
                ...
                <div className="pt-12 border-t border-slate-200 space-y-8">
                    <div className="max-w-4xl mx-auto space-y-6">
                        ...
                        <div className="flex flex-col items-center gap-4">
                            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em]">© 2024 Reconstrução Intensiva</p>
                        </div>
                    </div>
                </div>
              </div>
