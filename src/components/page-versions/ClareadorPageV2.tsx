...
export function ClareadorPageV2() {
  ...
  const [selectedKit, setSelectedKit] = useState<KitOption>(CLAREADOR_KITS[1]); // Kit 3 unidades como padrão (Mais Vendido)
