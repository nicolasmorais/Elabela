...
// CONFIGURAÇÃO DE PREÇOS ATUALIZADA (CARTÃO vs PIX)
const AMAZOLÉ_KITS = [
  {
    id: '1-un',
    name: '1 FRASCO',
      ...
      <div className="bg-white text-brand-text font-sans selection:bg-brand-blue/20 antialiased min-h-screen">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="aspect-square bg-slate-100 rounded-[2.5rem] border border-slate-200 flex items-center justify-center text-center p-6 text-slate-400 font-bold text-xs uppercase italic">
                            [FOTO {i}: ANTES/DEPOIS AXILAS, VIRILHAS OU ROSTO]
                        </div>
                    ))}
                </div>
        ...
        <section className="py-24 px-6">
            <div className="max-w-4xl mx-auto space-y-16">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-brand-pink font-black text-sm uppercase tracking-[0.3em]">FÓRMULA PATENTEADA DA AMAZÔNIA (Sem Ácidos Que Ardem)</p>
                </div>
        ...
        <section className="py-12 space-y-24">
            ...
            <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center border-t border-slate-50 pt-24">
                ...
                <div className="bg-slate-50 rounded-[4rem] aspect-square flex items-center justify-center p-12 text-slate-300 font-black italic border border-slate-100">
                    [IMAGEM: Infográfico Mulateiro/Torneira]
                </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="bg-slate-50 rounded-[4rem] aspect-square flex items-center justify-center p-12 text-slate-300 font-black italic border border-slate-100 order-2 lg:order-1">
                    [IMAGEM: Infográfico Melaleuca/Incêndio]
                </div>
            ...
            <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="bg-slate-50 rounded-[4rem] aspect-square flex items-center justify-center p-12 text-slate-300 font-black italic border border-slate-100">
                    [IMAGEM: Infográfico Argila/Lixa]
                </div>
            </div>
        </section>
            ...
            <div className="max-w-6xl mx-auto space-y-20 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                        ...
                        { i: Circle, t: "⚪ DOLOMITA", s: "(Mineral amazônico)", d: "Regenera células da pele. Clareia SEM ácidos agressivos.", f: "Mancha clareando progressivamente" },
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 border-t border-white/10 pt-16">
                    {["100% Natural (sem hidroquinona)", "pH Balanceado (não irrita)", "Fórmula Patenteada"].map((d, i) => (
                ...
                <div className="text-center pt-10">
                    <div className="bg-brand-pink p-10 rounded-[3rem] shadow-2xl inline-block group cursor-default transition-transform hover:scale-105">
                        ...
                        <p className="text-4xl md:text-5xl font-black tracking-tighter uppercase leading-none">Clareamento em 4 Semanas</p>
            ...
            <div className="max-w-4xl mx-auto space-y-16">
                ...
                <div className="bg-brand-gray-light p-10 md:p-16 rounded-[4rem] border border-slate-100 space-y-12">
                    ...
                    <div className="space-y-12">
                        {[
                            ...
                            { n: "2", t: "APLIQUE O AMAZOLÉ", d: "Pegue quantidade de 1 grão de ervilha. Espalhe na mancha em movimentos circulares até absorver. NÃO enxágue (deixa agir).", time: "2 minutos" },
                    ...
                    <div className="pt-8 border-t border-brand-blue/10 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="flex gap-4">
                            <div className="p-4 bg-white rounded-3xl border border-slate-100 space-y-1">
                                <p className="text-[10px] font-black uppercase text-brand-blue">MANHÃ</p>
                                <p className="text-xs font-bold text-slate-500">Após o banho, deixa agir o dia todo.</p>
                            </div>
                            <div className="p-4 bg-white rounded-3xl border border-slate-100 space-y-1">
                                <p className="text-[10px] font-black uppercase text-brand-pink">NOITE</p>
                                <p className="text-xs font-bold text-slate-500">Antes de dormir, age a noite toda.</p>
                            </div>
                        </div>
                        <div className="text-center md:text-right">
                            <p className="text-xs font-black uppercase text-slate-400 tracking-widest">TOTAL:</p>
                            <p className="text-3xl font-black text-brand-blue-dark">6 MINUTOS <span className="text-sm font-bold text-slate-400">(2X AO DIA)</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="p-10 bg-white border border-slate-100 rounded-[3rem] shadow-xl space-y-8">
                        <h3 className="text-xl font-black uppercase tracking-widest flex items-center gap-2"><Lightbulb className="text-brand-pink" /> POTENCIALIZAR RESULTADOS</h3>
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={i} className="flex gap-4">
                                    ...
                                    <div>
                                        <p className="text-xs font-black uppercase tracking-widest text-slate-900 mb-1">{tip.t}</p>
                    ...
                    <div className="bg-brand-blue-dark p-10 rounded-[3rem] text-white flex flex-col justify-between overflow-hidden relative">
                        <div className="absolute top-0 right-0 p-8 opacity-10"><Target size={120} /></div>
                        <div className="space-y-6 relative z-10">
                            <h3 className="text-xl font-black uppercase tracking-widest">ÁREAS TRATÁVEIS:</h3>
                            <div className="grid grid-cols-2 gap-y-4 gap-x-2">
                                {["Axilas", "Virilhas", "Melasma", "Idade", "Foliculite", "Cotovelos", "Pescoço", "Entre coxas"].map((a, i) => (
                                    <div key={i} className="flex items-center gap-2 text-sm font-bold">
                                        <Check className="text-brand-blue" size={16} /> {a}
                                    </div>
                                ))}
                            </div>
                        </div>
                        <div className="mt-10 pt-6 border-t border-white/10 relative z-10">
                            <p className="text-3xl font-black tracking-tighter uppercase leading-none">1 FRASCO = 1 ÁREA</p>
                            <p className="text-xs font-bold text-brand-blue uppercase mt-2">POR 30 DIAS DE USO CONTÍNUO</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-16">
                ...
                <div className="space-y-6">
                    {[
                        ...
                        <div key={i} className="flex flex-col md:flex-row gap-6 md:items-center bg-white p-8 rounded-[3rem] border border-slate-100 transition-all hover:border-brand-blue">
        ...
        <section className="py-32 px-6">
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                <div className="space-y-12">
                    ...
                    <div className="space-y-8">
                        <div className="flex gap-6 items-start">
                            ...
                            <div className="space-y-2">
                                <p className="text-2xl font-black text-brand-blue-dark uppercase tracking-tight">AMAZOLÉ CLAREADOR 50g</p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={i} className="flex items-center gap-3 text-sm font-bold text-slate-600">
                                    <div className="bg-emerald-50 p-1 rounded-full text-emerald-600"><Check size={14} strokeWidth={4} /></div>
                                    {li}
                                </div>
                            ))}
                        </div>
                ...
                <div className="bg-slate-50 rounded-[4rem] aspect-[4/3] flex items-center justify-center p-12 text-slate-300 font-black italic border-8 border-white shadow-2xl">
                    [IMAGEM: Kit Amazolé Completo]
                </div>
            </div>
        </section>

        {/* DEPOIMENTOS CLIENTES */}
        <section className="py-32 px-6 bg-brand-gray-light border-y border-slate-100">
            <div className="max-w-6xl mx-auto space-y-16">
                <div className="text-center space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {TESTIMONIALS.map((test, i) => (
                        <div key={i} className="group bg-white p-10 rounded-[3rem] border border-slate-100 shadow-xl flex flex-col justify-between hover:border-brand-blue transition-all hover:-translate-y-1">
                            <div className="space-y-6">
                            ...
                            <p className="pt-6 border-t border-slate-50 mt-8 font-black text-brand-blue-dark text-xs uppercase tracking-[0.2em]">{test.author}</p>
                        </div>
                    ))}
                </div>
            </div>
        ...
        <section className="py-32 px-6">
            <div className="max-w-4xl mx-auto space-y-16">
                ...
                <div className="space-y-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <Accordion type="single" collapsible className="w-full space-y-4">
                            {[
                                ...
                                { q: "❓ Já tentei mil clareadores e nenhum funcionou. Por que este seria diferente?", a: "Porque os outros usam ÁCIDOS que ardem, descascam e irritam. Amazolé usa BOTÂNICA: Mulateiro bloqueia melanina NA RAIZ sem agredir." },
                                { q: "❓ Funciona para melasma?", a: "SIM. O melasma é acúmulo de melanina e o Mulateiro inibe essa produção excessiva. MAS: Precisa usar protetor solar FPS 50+ TODO DIA. Sem protetor = mancha volta." },
                                { q: "❓ Arde? Descasca a pele?", a: "NÃO. Fórmula 100% natural, sem ácidos agressivos. Pode sentir leve formigamento na 1ª aplicação por causa do Óleo de Melaleuca agindo. É normal e passa em 2-3 minutos." },
                                { q: "❓ Tenho pele sensível/alérgica. Posso usar?", a: "PODE. Fórmula natural, pH balanceado e testada dermatologicamente. Indicado para peles sensíveis. Sempre faça o teste atrás da orelha antes." },
                                { q: "❓ Quanto tempo para ver resultado?", a: "Semana 1-2: Pele uniforme. Semana 3-4: Clareamento visível (30-40%). Semana 5-8: Clareamento intenso (50-70%). Varia por pessoa e tipo de mancha." },
                                { q: "❓ Preciso usar para sempre?", a: "FASE INTENSIVA (primeiros 2-3 meses): 2x ao dia. FASE MANUTENÇÃO: 1x ao dia ou 3-4x por semana para manter os resultados e prevenir novas manchas." },
                                { q: "❓ Funciona em pele negra?", a: "SIM. Funciona em TODOS os tons de pele. O clareamento em peles negras é progressivo e visa UNIFORMIZAR o tom com a pele saudável ao redor." },
                                { q: "❓ Posso usar no rosto todo dia?", a: "PODE. Mas SEMPRE use protetor solar depois. Sol sem protetor = mancha volta pior." }
                            ].map((item, i) => (
                                <AccordionItem key={i} value={`prod-${i}`} className="bg-brand-gray-light border-none rounded-3xl px-8 shadow-sm">
                                    ...
                                    <AccordionContent className="text-slate-500 font-medium text-lg leading-relaxed pb-8">{item.a}</AccordionContent>
                                </AccordionItem>
                            ))}
                        </Accordion>
                    </div>
                    ...
                    {/* CATEGORIA: PAGAMENTO */}
                    <div className="space-y-6">
                        <h3 className="text-xl font-black text-brand-pink uppercase tracking-widest flex items-center gap-3 border-b-2 border-brand-pink/10 pb-1">💳 PREÇO E PAGAMENTO</h3>
                        <Accordion type="single" collapsible className="w-full space-y-4">
                            {[
                                { q: "❓ Por que R$ 137?", a: "Ingredientes importados da Amazônia com processo de extração artesanal caro. Fórmula patenteada. Comparado ao laser (R$ 800+), é a solução mais barata que FUNCIONA." },
                                { q: "❓ Posso parcelar?", a: "SIM. Até 12x de R$ 13,90 sem juros no cartão de crédito. Ou R$ 127 no PIX com o desconto promocional aplicado." },
                                { q: "❓ Quanto comprar?", a: "Recomendamos: 1 ÁREA (axila OU virilha) = 2 frascos (60 dias). 2 ÁREAS (axila + virilha) = 3 frascos (90 dias). Quanto mais tempo usar = melhor o resultado." },
                                { q: "❓ E se não funcionar?", a: "GARANTIA INCONDICIONAL DE 90 DIAS. Use por 3 meses inteiros. Não clareou? Manda 1 e-mail. Devolvemos 100% do valor. Sem burocracia." }
                            ].map((item, i) => (
                    ...
                    <div className="space-y-6">
                        ...
                        <Accordion type="single" collapsible className="w-full space-y-4">
                            {[
                                { q: "❓ Frete é grátis?", a: "SIM. Para TODO o Brasil. Rastreio e Seguro de entrega inclusos em todos os pedidos hoje." },
                                { q: "❓ Quanto tempo para chegar?", a: "Sudeste/Sul: 3-7 dias úteis. Demais regiões: 5-12 dias úteis. Enviamos em até 24h úteis após confirmação." },
                                { q: "❓ É seguro comprar?", a: "100% SEGURO. Site com Certificado SSL, Checkout criptografado, nota fiscal e respeitamos a LGPD." }
                            ].map((item, i) => (
                    ...
                    <div className="space-y-6">
                        ...
                        <Accordion type="single" collapsible className="w-full space-y-4">
                            {[
                                { q: "❓ Quanto tempo dura 1 frasco?", a: "30 DIAS tratando 1 ÁREA. Áreas pequenas (axila) podem durar até 45 dias. Áreas grandes (costas) duram 20 dias." },
                                { q: "❓ Posso usar durante a gravidez?", a: "Produto natural de uso externo = Geralmente seguro. MAS: Sempre consulte seu obstetra antes, pois cada gravidez é única." },
                                { q: "❓ Posso misturar com outros cremes?", a: "NÃO RECOMENDAMOS. Use apenas o Amazolé na área para não anular o efeito. Pode usar protetor/maquiagem DEPOIS de absorver." },
                                { q: "❓ Preciso depilar antes de usar?", a: "NÃO precisa. Funciona com ou sem pelo. Se depilar, espere 24h antes de aplicar para evitar ardência na pele irritada." },
                                { q: "❓ Ainda tenho dúvidas. Como falar com vocês?", a: "Mande um e-mail para 📧 contato@amazole.com.br. Respondemos em até 24h úteis." }
                            ].map((item, i) => (
        ...
        <section className="py-24 px-6 bg-white border-t border-slate-50">
            <div className="max-w-4xl mx-auto text-center space-y-10">
                <div className="bg-[#FDF8F3] border-[6px] border-dashed border-brand-blue/30 p-12 md:p-24 rounded-[4rem] relative overflow-hidden">
                    ...
                    <h2 className="text-4xl md:text-6xl font-black text-brand-blue-dark uppercase tracking-tighter mb-8 leading-tight">GARANTIA SATISFAÇÃO <br /> OU DINHEIRO DE VOLTA</h2>
                    <p className="text-2xl text-slate-600 font-medium italic mb-10 leading-relaxed max-w-2xl mx-auto">
                        Use o Amazolé por 90 dias inteiros. Se não ver clareamento visível, devolvemos 100% do seu dinheiro. Sem perguntas. Sem enrolação.
                    </p>
                    <div className="inline-block px-10 py-3 bg-brand-blue-dark text-white rounded-full font-black text-xs uppercase tracking-[0.3em]">90 DIAS DE GARANTIA</div>
                </div>
            </div>
        </section>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="py-8 bg-brand-gray-light rounded-[2.5rem] space-y-2">
                                    ...
                                    <div className="space-y-0 text-brand-blue-dark">
                                        ...
                                        <p className="text-[10px] font-black uppercase text-emerald-600 tracking-[0.2em] mt-2">Valor Especial no PIX</p>
                                    </div>
                                </div>
                ...
                <div className="py-20 space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        ...
                        <div className="bg-emerald-500/10 border-4 border-emerald-500 p-10 rounded-[3rem] text-left space-y-6 shadow-[0_0_50px_rgba(16,185,129,0.2)]">
                            <p className="text-2xl font-black text-emerald-400 uppercase tracking-tighter">2️⃣ CLICAR AGORA</p>
            ...
            <div className="max-w-6xl mx-auto px-6 space-y-20">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    <nav className="flex flex-wrap justify-center gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
                        <Link href="#" className="hover:text-brand-pink transition-colors">Termos e Condições</Link>
                        <Link href="#" className="hover:text-brand-pink transition-colors">Política de Privacidade</Link>
                        <Link href="#" className="hover:text-brand-pink transition-colors">Política de Reembolso</Link>
                    </nav>
            ...
            <Link href={selectedKit.checkoutUrl} className="block" target="_blank">
                <Button className="w-full h-16 bg-brand-pink hover:bg-brand-pink-dark text-white rounded-2xl shadow-xl flex items-center justify-between px-5 font-black uppercase">
                    <div className="flex flex-col items-start leading-tight border-r border-white/20 pr-4">
                        <span className="text-[10px] opacity-70">Kit 1: R$ 137</span>
                        <span className="text-lg">PIX: R$ 127</span>
                    </div>
