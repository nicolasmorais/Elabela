...
const DELIVERY_TESTIMONIALS = [
  ...
  },
  {
    ...
    text: "Entrega relâmpago aqui no RJ! Usei hoje pela primeira vez e o perfume é incrível. Já sinto a diferença na quebra.",
                        ...
                        <div className="space-y-6">
                            ...
                            <Accordion type="single" collapsible className="w-full space-y-3">
                                {[
                                    ...
                                    { q: "❓ Tenho couro cabeludo oleoso/seco. Posso usar?", a: "PODE. E deve. Kit reconstrói." },
