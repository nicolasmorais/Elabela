...
const defaultApprovalPageContent: ApprovalPageContent = {
  ...
  footer: {
    disclaimer: "<strong>AVISO LEGAL:</strong> Este produto não substitui o parecer médico profissional. Sempre consulte um profissional da saúde para tratar de assuntos relativos à saúde. Os resultados podem variar de pessoa a pessoa.",
